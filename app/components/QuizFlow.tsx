...
export default function QuizFlow({ profile, setProfile, prefill, onDone }: Props) {
  ...
  async function handleNext() {
    if (currentIndex + 1 < questions.length) {
      ...
      // (it was updated synchronously in handleOptionSelect before the user clicked Next)
    ...
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      {state === "loading" && (
        <div className="bg-white rounded-2xl border border-stone-100 p-8 shadow-sm text-center">
          <div className="w-16 h-16 rounded-2xl bg-indigo-50 text-indigo-600 mx-auto flex items-center justify-center text-2xl mb-4 animate-pulse">
            ✨
          </div>
          ...
          <div className="space-y-3 max-w-md mx-auto">
            <div className="h-4 bg-stone-100 rounded-full animate-pulse w-3/4 mx-auto" />
            <div className="h-4 bg-stone-100 rounded-full animate-pulse w-1/2 mx-auto" />
          </div>
        </div>
      )}
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl border border-stone-100 p-8 shadow-sm text-center">
        ...
        {/* Badge celebration if any unlocked */}
        {resultData.newBadges.length > 0 && (
          <div className="mb-6 p-4 rounded-2xl bg-gradient-to-r from-indigo-50 via-purple-50 to-indigo-50 border border-indigo-200 text-center">
